		...
		<div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3 lg:gap-5">
			{stats.map((stat) => (
				<article
					key={stat.label}
					data-animate
					className="flex sm:h-[90px] md:h-[120px] items-center justify-center border border-white/8 bg-[rgba(0,0,0,0.30)] px-6 py-4 backdrop-blur-[2.75px] sm:px-8 lg:px-[60px] lg:py-[40px]"
				>
