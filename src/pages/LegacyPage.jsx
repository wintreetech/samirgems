...
function LegacyPage() {
	return (
		<>
			...
			<section className="bg-black px-6 py-16 md:px-10 lg:px-14 xl:px-20 2xl:px-24">
				<div className="grid w-full items-stretch gap-8 lg:grid-cols-[40%_60%]">
					<div className="flex flex-col justify-start pr-8 lg:pr-14">
						<h2 className="mb-16 font-display text-[4rem] uppercase text-white">
							Our Origins
						</h2>
						<h3 className="mb-12 font-copy text-4xl leading-tight text-stone-100">
			...
			<section className="bg-black px-6 py-16 md:px-10 lg:px-14 xl:px-20 2xl:px-24">
				<div className="grid w-full items-stretch gap-8 lg:grid-cols-[60%_40%]">
					...
					<div className="flex flex-col justify-start pl-8 lg:pr-14">
						<h3 className="my-12 font-copy text-4xl leading-tight text-stone-100">
